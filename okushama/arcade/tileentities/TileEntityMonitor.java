package okushama.arcade.tileentities;
...
public class TileEntityMonitor extends TileEntity implements IArcadeMachine {
	 ...
	 */
	@Deprecated
	public TileEntityMonitor setGame(IArcadeGame newGame) {
		game = newGame;
	...
	public void updateEntity() {
		if (getWorldObj().isRemote) {
			...
			if (user instanceof EntityPlayer) {
				if(((EntityPlayer)user).getCurrentEquippedItem() != null){
					ItemStack itemstack = ((EntityPlayer)user).getCurrentEquippedItem();
					if(itemstack.itemID != Items.joystick.itemID){
						user = null;
					}
				}
				if(user != null) {
